...
public class CMainPanel extends JPanel {
    ...
    public void saveNote() {
        ...
        if (!note.isEmpty()) {
            ...
            //FileUtils.fileOutputStreamWriter(note);
            FileUtils.fileSerializeWrite(note);
        }
        updateListGUI();
    }
...
//                String content = FileUtils.fileInputStreamReader(curr[index]);
                String content = FileUtils.fileSerializeRead(curr[index]);
